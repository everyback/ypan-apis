...
use App\Http\Middleware\DecodeInput;
use App\Http\Middleware\DownloadFileMiddleware;
use App\Http\Middleware\FileMiddleware;
use App\Http\Middleware\FolderMiddleware;
use App\Http\Middleware\Register;
use App\Providers\GridFsServeProvider;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'decode'=>\App\Http\Middleware\DecodeInput::class,
